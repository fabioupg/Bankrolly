  ...
  return (
    <SafeAreaView edges={['bottom']} style={styles.safe}>
      <View style={styles.header}>
        <Text style={styles.title}>{players.length} player{players.length === 1 ? '' : 's'}</Text>
        <Pressable onPress={() => router.push('/players/new')} style={styles.addBtn}>
      ...
      <View style={styles.searchWrap}>
        <TextInput
          ...
          placeholder="Search by name, nickname, venue, archetype"
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyBody}>
              {players.length === 0
                ? 'Track regulars and tough opponents — what they open, how they bet, when they bluff.'
                : 'Try a different name or clear the search.'}
            </Text>
            {players.length === 0 ? (
              <Pressable onPress={() => router.push('/players/new')} style={styles.bigAddBtn}>
